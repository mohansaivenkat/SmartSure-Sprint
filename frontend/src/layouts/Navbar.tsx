...
import { selectDarkMode, toggleTheme } from '../store/themeSlice';
import {
...
export default function Navbar() {
  ...
  const publicLinks: NavLinkConfig[] = [
  ...
  const customerLinks: NavLinkConfig[] = [
    ...
    { to: '/claims',      label: 'Claims',    icon: HiClipboardList },
      ...
      <nav className="nav-root nav-bar">
        <div className="nav-inner">
          ...
          <div className="nav-right">
            {/* Theme toggle */}
            <button className="nav-icon-btn" onClick={handleToggleTheme} aria-label="Toggle theme">
        ...
        <div className="mob-only">
          ...
          <div className="mob-drawer" ref={drawerRef} role="dialog" aria-modal="true" aria-label="Navigation menu">
            ...
            <div className="mob-drawer-foot">
              <button onClick={handleToggleTheme} className="mob-link" style={{ width: '100%', border: '1.5px solid var(--color-border)', background: 'var(--color-surface)' }}>
